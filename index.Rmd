...
formatContrastRatio = function(el) {
  let fg = window.getComputedStyle(el).getPropertyValue('color')
...
<div id="demo-text" class="bg-white black"><h2>Preview</h2><p>Click on a color below</p><div id="demo-contrast" title="WCAG Contrast Ratio"></div></div>
